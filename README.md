...
Output: Artificial Intelligence (AI) is the capability of computational systems to perform tasks such as learning, reasoning, problem-solving, and decision-making.
